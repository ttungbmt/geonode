...
_default_public_location = '{}://{}:{}/geoserver/'.format(
    ...
    GEOSERVER_PUBLIC_PORT) if GEOSERVER_PUBLIC_PORT else f'{GEOSERVER_PUBLIC_SCHEMA}://{GEOSERVER_PUBLIC_HOST}/geoserver/'
...
try:
    ...
    PROXY_ALLOWED_HOSTS = [
        ...
        'dev.openlayers.org'] if os.getenv('PROXY_ALLOWED_HOSTS') is None else re.split(
        r' *[,|:|;] *',
        os.getenv('PROXY_ALLOWED_HOSTS'))
...
if GEONODE_CLIENT_LAYER_PREVIEW_LIBRARY == 'mapstore':
    ...
    if MAPBOX_ACCESS_TOKEN:
        BASEMAP = {
            ...
            "source": "streets-v11",
            "thumbURL": f"https://api.mapbox.com/styles/v1/mapbox/streets-v11/tiles/256/6/33/23?access_token={MAPBOX_ACCESS_TOKEN}",
            "group": "background",
            "visibility": True}
